...
import gov.nasa.jpf.symbc.realtime.rtsymexectree.ATimingDocNode;
 ...
 *
 */
public class TimingDocInvokeNode extends RTInvokeNode implements ITimingDocRealTimeNode {

	private InstructionTimingInfo instrTimingInfo;
	public TimingDocInvokeNode(InstrContext instructionContext, InstructionTimingInfo instrTiming) {
		this(instructionContext, null, instrTiming);
	}

	public TimingDocInvokeNode(InstrContext instructionContext, SymbolicExecutionTree tree, InstructionTimingInfo instrTiming) {
