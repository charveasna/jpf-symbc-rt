package gov.nasa.jpf.symbc.realtime.md5.util;
...
public class MD5 {
	...
	this.TransformPart2(state, a, b, c, d, x);
    }

    /*Introduced to avoid JOP limit of method size*/
    private void TransformPart2 (MD5State state, int a,  int b, int c, int d, int[] x) {
     ...
     */
    private int[] decode_buf = new int[16];
    ...
    public void Update (String s, String charset_name) throws java.io.UnsupportedEncodingException {
        if (charset_name == null) charset_name = new String("ISO8859_1");
